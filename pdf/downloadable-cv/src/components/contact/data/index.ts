...
export const jobDescriptions = [
  {
    companyName: 'SFTUE BSVT, Belarus',
    years: '2007 - 2017',
    position: 'Translator/ Interpreter/ Project Manager',
    responsibilities: [
      'Ran and supervised company projects overseas',
      'Trained and motivated team to increase quality of their service',
      'Assisted with team training and recruitment of energetic and customer focused individuals',
      'Planned working schedule of the team working overseas'
    ]
  },
  {
    companyName: 'Yingjiayi LLC, China',
    years: '2017 - present',
    position: 'Analyst, manager of eBay and Amazon accounts',
    responsibilities: [
      'Ran the company\’s business on eBay and Amazon in the US and Canada',
      'Performed analysis sales and customer data',
      'Planned products shipment and assured quality of the shipped products',
      'Improved operational management systems, processes and best practices',
      'Contributed towards the company\’s strategic and operational objectives to drive revenue',
    ]
  }
];
...
export const skills = [
  ...
  },
  {
    title: 'Soft Skills',
    skillsList: [
      'Communication skills in various international settings',
      'Problem-solving',
